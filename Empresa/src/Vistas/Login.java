...
public class Login extends javax.swing.JFrame {
    ...
    private static Login login; //se crea una variable login de tipo estatica para que solo haya una instancia de la clase Login
    private DAOLogin cLogin=ControladorLogin.getControladorLogin(); 
    //con el uso de cLogin se puede llamar la clase ControladorLogin que a su vez implementa la DAOLogin y se puede usar el metodo getControladorLogin()
    ...
    /**
     * este metodo se conoce como singleton el cual hace conserva datos para que solo haya una instancia de la clase Login con la variable login
     * con el condicional verifica si login esta vacio crea una nueva instancia y la devuelve
     */
    ...
    private void usuarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_usuarioMouseClicked
        ...
        usuario.setText(""); //cuando se da clic en la pantalla de usuario se borra el texto
    }//GEN-LAST:event_usuarioMouseClicked

    private void contraseniaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_contraseniaMouseClicked
        // TODO add your handling code here:
        contrasenia.setText("");//cuando se da clic en la pantalla de contraseña se borra el texto
    ...
    private void olvidoMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_olvidoMouseEntered
        // TODO add your handling code here:
        olvido.setForeground(new java.awt.Color(51, 0, 255)); //cambia el color cuando pása el mouse por el texto 
    ...
    private void olvidoMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_olvidoMouseExited
        // TODO add your handling code here:
        olvido.setForeground(new java.awt.Color(0, 0, 0)); //vuelve el color original cuando se quita el mouse
    }//GEN-LAST:event_olvidoMouseExited
    
    /** 
     * con el condicional permite ver si los usuarios son correctos o no
     * se utiliza el cLogin que llama al metodo VerificarUsuarios para validar si estan correctos
     */
